...
declare class TelegramPhotoSize{
    public file_id : string;
    public width : number;
    public height : number;
    public file_size : number;
}
declare class TelegramVenue{
    public location : TelegramLocation;
    public title : string;
    public address : string;
    public foursquare_id : string;
}
declare class TelegramLocation{
    public longitude : number;
    public latitude : number;
}
declare class TelegramContact{
    public phone_number : string;
    public first_name : string;
    public last_name : string;
    public user_id : number;
}
declare class TelegramVoice{
    public file_id : string;
    public duration : number;
    public mime_type : string;
    public file_size : number;
}
declare class TelegramVideo{
    public file_id : string;
    public width : number;
    public height : number;
    public duration : number;
...
declare class TelegramVideoNote{
    public file_id : string;
...
declare class TelegramDocument{
    public file_id : string;
    public thumb : TelegramPhotoSize;
...
declare class TelegramMessageEntity{
    public type : string;
...
declare class TelegramChatPhoto{
    public small_file_id : string;
    public big_file_id : string;
}
declare class TelegramUserProfilePhotos{
    public total_count : number;
    public photos : TelegramPhotoSize[];
}

declare class TelegramFile{
    public file_id : string;
    public file_size : number;
    public file_path : string;
}
declare class TelegramReplyKeyboardMarkup{
...
declare class TelegramKeyboardButton{
    public text : string;
    public request_contact : boolean;
    public request_location : boolean;
}
declare class TelegramReplyKeyboardRemove{
    public remove_keyboard : boolean;
    public selective : boolean;
}
declare class TelegramInlineKeyboardMarkup{
...
declare class TelegramCallbackGame{
    //placeholder?
}
declare class TelegramForceReply{
    public force_reply : boolean;
    public selective : boolean;
}
declare class TelegramChatMember{
    public user : TelegramUser;
...
declare class TelegramResponseParameters{
    public migrate_to_chat_id : number;
    public retry_after : number;
}

declare class TelegramInputMedia{
    public type : string;
    public media : string;
    public caption : string;
}
declare class TelegramInputMediaPhoto extends TelegramInputMedia {
    //equals TelegramInputMedia
}
declare class IelegramInputMediaVideo extends TelegramInputMedia{
    public width : number;
    public height : number;
    public duration : number;
}

declare class TelegramLabeledPrice{
    public label : string;
    public amount : number;
}

declare class TelegramSuccessfulPayment{
...
declare class TelegramShippingAddress{
...
declare class TelegramOrderInfo{
    public name : string;
    public phone_number : string;
    public email : string;
    public shipping_address : TelegramShippingAddress;
}
declare class TelegramShippingOption{
    public id : string;
    public title : string;
    public prices : TelegramLabeledPrice[];
}
declare class TelegramShippingQuery{
    public id : string;
    public from : TelegramUser;
    public invoice_payload : string;
    public shipping_address : string;
}
declare class TelegramPreCheckoutQuery{
    public id : string;
    public user : TelegramUser;
    public currency : string;
    public total_amount : number;
...
declare class TelegramAnimation{
    public file_id : string;
    public thumb : TelegramPhotoSize;
    public file_name : string;
    public mime_type : string;
...
declare class TelegramSendMessage{
...
declare class TelegramInlineQuery{
    public id : string;
    public from : TelegramUser;
    public location : TelegramLocation;
    public query : string;
...
declare class TelegramCallbackQuery{
    public id : string;
    public from : TelegramUser;
    public message : TelegramMessage;
    public inline_message_id : string;
...
declare class TelegramResponse<T>{
    public ok : boolean;
    public result : T;
    public description : string;
